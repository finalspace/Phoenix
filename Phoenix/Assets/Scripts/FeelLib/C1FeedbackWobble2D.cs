...
{
    [C1FeedbackAttributeName("Wobble2D")]
    public class C1FeedbackWobble2D : C1Feedback
    {
        ...
        protected virtual void ComputeNewLocalScale()
        {
            ...
            if (_squashing)
            {
                ...
                sampleKey = Mathf.Repeat(TimescaleTime - squashStartAt, duration);
                elapsed = C1Maths.Remap(sampleKey, 0f, duration, 0f, 1f);
            ...
            else
            {
                ...
                if (TimescaleTime - releaseStartAt > duration * 3)
                {
                    Stop();
                }
            }

            _newLocalScale.x = _initialScale.x + stretchVal * intensity;
            _newLocalScale.y = _initialScale.y - stretchVal * intensity * 2;
            _newLocalScale.z = _initialScale.z + stretchVal * intensity;
